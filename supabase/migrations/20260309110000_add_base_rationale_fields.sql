-- Migration: Add base rationale fields to vehicle_configs
ALTER TABLE vehicle_configs ADD COLUMN IF NOT EXISTS default_best_for text;
ALTER TABLE vehicle_configs ADD COLUMN IF NOT EXISTS default_why_it_fits text[];
ALTER TABLE vehicle_configs ADD COLUMN IF NOT EXISTS default_tradeoffs text[];
ALTER TABLE vehicle_configs ADD COLUMN IF NOT EXISTS default_trim_guidance text;
...
SELECT
  ...
  vc.config_notes,
  vc.default_best_for,
  vc.default_why_it_fits,
  vc.default_tradeoffs,
  vc.default_trim_guidance,
  ms.base_msrp,
  ms.top_trim_msrp,
  ds.length_in,
  ds.width_in,
