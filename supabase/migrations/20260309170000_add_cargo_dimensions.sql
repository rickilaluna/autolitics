-- Migration: Add extra cargo dimension fields

-- 1. Add fields to dimension_specs
ALTER TABLE public.dimension_specs
ADD COLUMN IF NOT EXISTS cargo_behind_2nd_cu_ft NUMERIC(5,1),
ADD COLUMN IF NOT EXISTS trunk_volume_cu_ft NUMERIC(5,1);

-- 2. Update v_vehicle_config_profile view to include new fields
